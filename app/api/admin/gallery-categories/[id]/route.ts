  ...
  try {
    ...
    try {
      category = await client.fetch(`
        *[_type == "galleryCategory" && _id == $id][0] {
          _id,
          title,
          slug,
          description,
      ...
      console.error('Error fetching gallery category:', fetchError);
      return api.error('Failed to fetch gallery category', {
    ...
    if (!category) {
      return api.error('Gallery category not found', {
...
export async function PUT(
  ...
  try {
    ...
    try {
      ...
      console.error('Error updating gallery category:', updateError);
      return api.error('Failed to update gallery category', {
        code: 'GALLERY_CATEGORY_UPDATE_ERROR',
        status: 500
      });
    }
...
export async function DELETE(
  ...
  try {
    ...
    try {
      ...
      console.error('Error deleting gallery category:', deleteError);
      return api.error('Failed to delete gallery category', {
        code: 'GALLERY_CATEGORY_DELETE_ERROR',
        status: 500
      });
    }
